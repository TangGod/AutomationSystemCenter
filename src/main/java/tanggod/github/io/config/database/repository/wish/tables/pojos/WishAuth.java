...
public class WishAuth implements Serializable {

    private static final long serialVersionUID = -1674920378;
    ...
    public WishAuth(WishAuth value) {
        this.id = value.id;
    ...
    public String toString() {
        StringBuilder sb = new StringBuilder("WishAuth (");
